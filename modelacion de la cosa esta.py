...
while i < 180:
    ...
    #Checar si las magnitudes coincide, y como los angulos son los mismos esto nos va a decir si estos puntos coinciden y por lo tanto si los 2 objetos chocan 
    coord1=round(c1,2)
    coord2=round(c3,2)
    coord3=round(c2,2)
    coord4=round(c4,2)
